...
INSTANTIATE_TEST_SUITE_P(ParamTestCorrectFormedJson, 
                         FlightInfoOne_test,
                         testing::Values(
    TestData{R"({"x_data":15,"y_data":99})", FlightInfoOneData{15, 99}, "INSERT INTO F1 VALUES (1485)"},
    TestData{R"({"x_data":1,"y_data":438})", FlightInfoOneData{1, 438}, "INSERT INTO F1 VALUES (438)"},
    TestData{R"({"x_data":100,"y_data":99})", FlightInfoOneData{100, 99}, "INSERT INTO F1 VALUES (9900)"}
));
